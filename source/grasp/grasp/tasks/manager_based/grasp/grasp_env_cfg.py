...
# Pre-defined configs
##
from grasp.assets.robots.spot_cfg import SPOT_CFG  # isort: skip


@configclass
class SpotGraspEnvRoughCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.scene.contact_sensors = contact_forces
        self.scene.body_contact_forces = ContactSensorCfg(
            prim_path="{ENV_REGEX_NS}/Robot/body", update_period=0.0, history_length=6, debug_vis=True
        )
        
        #eventsss_distribution_params"] = (-1.0, 3.0)
...
@configclass
class SpotGraspEnvFlatCfg(SpotGraspEnvRoughCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
