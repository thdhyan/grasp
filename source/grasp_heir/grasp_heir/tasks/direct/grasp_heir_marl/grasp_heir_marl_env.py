...
from .grasp_heir_marl_env_cfg import GraspHeirMarlEnvCfg


class GraspHeirMarlEnv(DirectMARLEnv):
    cfg: GraspHeirMarlEnvCfg

    def __init__(self, cfg: GraspHeirMarlEnvCfg, render_mode: str | None = None, **kwargs):
